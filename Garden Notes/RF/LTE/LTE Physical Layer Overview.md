...
![[_attachments/lte_ul_frame.png]]

A user cannot transmit both PUCCH and PUSCH data in the same slot.

![[_attachments/lte_sc-fdma.png]]

![[_attachments/lte_dl_tx-2.png]]
