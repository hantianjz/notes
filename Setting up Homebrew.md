...
# Setting up Homebrewo
Setting up homebrew on the recent recent MacOS seem to land it in the `/opt/` folder. Where all the installed binary are not located in the `/usr/local/bin` anymore. Which is a none typical setup place.
